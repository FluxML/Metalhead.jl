...
See the paper [An Image is Worth 16x16 Words: Transformers for Image Recognition at Scale](https://arxiv.org/abs/2010.11929).
...
Creates a Vision Transformer (ViT) model with a standard configuration.
